...
- **M2 は実装済み**（[`done/tasks-m2.md`](done/tasks-m2.md)）。OpenAI 変換層は M2/M3 共有の `example/shared/`（`Example\Shared`）に配置済み（D28）。
...
- [ ] ⚠️ 詳細仕様は [`done/tasks-m2.md`](done/tasks-m2.md) T3 と同一。重複記述せず M2 の決定（D19/D20）に従う
